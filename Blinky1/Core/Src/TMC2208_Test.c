...
void Test_ActualIOIN(void) {
    ...
    test2_enn = TMC2208_IOIN_ReadPin(ioin, TMC2208_IOIN_PIN_ENN);
    test2_ms1 = TMC2208_IOIN_ReadPin(ioin, TMC2208_IOIN_PIN_MS1);
    test2_ms2 = TMC2208_IOIN_ReadPin(ioin, TMC2208_IOIN_PIN_MS2);
